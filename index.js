...
function openMenu() {
    ...
    menuVisibility.setAttribute('class', 'z-20 absolute flex laptop:hidden w-full h-[50vh] bg-white drop-shadow-xl flex flex-col justify-center items-center justify-around py-10');
...
function closeMenu() {
    menuVisibility.removeAttribute('class');
    menuVisibility.setAttribute('class', 'z-20 absolute hidden laptop:hidden w-full h-[50vh] bg-white drop-shadow-xl flex flex-col justify-center items-center justify-around py-10');
    menuOpenBtnVisibility.removeAttribute('class');
